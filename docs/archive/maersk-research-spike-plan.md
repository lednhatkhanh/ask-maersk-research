# Archived Maersk research spike plan

Historical reference only. The active slide-generation plan is [PLAN.md](../../PLAN.md). The original research-spike text follows and may contain outdated recommendations.
